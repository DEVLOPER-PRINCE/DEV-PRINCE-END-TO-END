...
def createItem(dataFB, nameItem, brandItem, priceItem, currencyItem, decriptionItem, hashtagList, typeItem, photoIDList, locationSeller):
    ...
    # Data liya aur likha gaya: 22:25 Tuesday, 10/10/2023. Author: Prince Malhotra
    # Shukriya @syrex1013 (Github) tumhare idea ke liye
    # Shukriya @tranngocminh230791 (Github) categoryDict ke liye
    ...
    try:
        ...
        a = {
            "success": 1, 
            "messages": "Marketplace listing successfully created!", 
            "data": {
                    "url": urlPost,
                    "id": idPost
            }
        ...
        a = {
            "error": 1,
            "messages": "Error creating marketplace listing: " + str(sendRequests)
        }
...
def getInformationProductItemMarketPlace(dataFB, idProductItem):
        ...
        try:
            ...
            a = {
                "success": 1,
                "messages": "Product information successfully retrieved!",
                "data": {
            ...
            a = {
                "error": 1,
                "messages": "Error retrieving product info: " + str(sendRequests)
            }
