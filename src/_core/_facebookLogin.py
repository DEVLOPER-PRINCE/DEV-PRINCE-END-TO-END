...
class loginFacebook:
     ...
     def __init__(self, username, password, AuthenticationGoogleCode=None):
          ...
          self.usernameFacebook = username # IDFB or email/phone number needed for login
          self.passwordFacebook = password # Password of the account
          self.twoTokenAccess = AuthenticationGoogleCode # string of 16 characters (or more) provided by Facebook
          
          """
          Note: 
               - English: If you don't have two-factor authentication set up, you can skip it.
               - Roman Hindi: Agar aapne two-factor authentication set nahi ki hai, toh aap ise skip kar sakte hain.
          """
