...
Koi sawaal ho toh [GitHub Issues](https://github.com/PrinceMalhotra/fbchat-v2/issues) par poochhna.
...
For E2EE reactions, the Go bridge exposes `SendE2EEReaction` but the Python wrapper does not surface it yet — track [Issues](https://github.com/PrinceMalhotra/fbchat-v2/issues) for progress.
...
> Agar tum contribute karna chahte ho toh [GitHub](https://github.com/PrinceMalhotra/fbchat-v2/issues) par aao — har ek contribution ka swagat hai! 🙌
>
> — *Prince Malhotra*, last updated June 2026
