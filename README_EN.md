...
[**📖 Docs**](DOCS.md) · [**📦 PyPI**](https://pypi.org/project/fbchat-v2/) · [**📊 Flowchart**](FLOWCHART.md) · [**🐛 Report a bug**](https://github.com/PrinceMalhotra/fbchat-v2/issues)
...
Hello, I am **Prince Malhotra** — the author and maintainer of this project.

First and foremost, a heartfelt thank-you to every contributor who has shared ideas and reported issues. The **major v2.x update** ships a complete restructure of the codebase, fixes the vast majority of long-standing minor bugs, and lays the groundwork for upcoming features such as E2EE and full `async`/`await` support.

There are still rough edges left to polish. If you spot any, please open an issue on [GitHub](https://github.com/PrinceMalhotra/fbchat-v2/issues).
...
Open [`src/config.json`](src/config.json) and paste your Facebook session cookies into the `cookies` field.
...
Full API details: [`src/_messaging/README_EN.md`](src/_messaging/README_EN.md) and [DOCS.md](DOCS.md).
...
| Key | Description |
|---|---|
| `cookies` | Your Facebook session cookies (string form). **Required.** |
| `prefix` | Command prefix for the bot (e.g. `/`, `!`, `.`) |
| `admins` | List of admin Facebook IDs |
...
Have ideas? Drop them in [Issues](https://github.com/PrinceMalhotra/fbchat-v2/issues).
...
> If you've contributed and your name isn't listed here, please open an issue or PR — it would be a pleasure to add you.
